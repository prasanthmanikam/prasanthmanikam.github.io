                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse ">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="view_order.php">Home</a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="update_order.php" data-toggle="modal">UPDATE ORDERS</a></li>

                                </ul>
                            </li>
                            <li><a href="view_technician.php">Technicians</a></li>
